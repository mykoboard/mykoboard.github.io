...
<template>
  <div class="space-y-8">
    ...
    <div
      v-if="isApproving && state?.context?.pendingGuest"
      class="fixed inset-0 z-[100] flex items-center justify-center bg-[#0A0A0A]/80 backdrop-blur-xl animate-fade-in p-6"
    >
    ...
    <div
      v-if="isInitiator && pendingJoinRequests && pendingJoinRequests.length > 0"
      class="glass-dark p-8 border border-primary/20 shadow-glass-dark rounded-[2.5rem] animate-zoom-in space-y-6"
    >
      ...
      <div class="space-y-4">
        <div
          ...
          class="glass-darker p-6 rounded-2xl border border-white/5 space-y-4"
        >
          <div class="flex items-start justify-between">
            <div class="space-y-2">
              <div class="flex items-center gap-2">
                ...
                <span
                  v-if="friendStatus[request.publicKey]"
          ...
          <div
            v-if="!friendStatus[request.publicKey]"
            class="flex items-center justify-end gap-2 px-1 pb-2"
          >
    ...
    <div
      v-if="isHosting || isJoining || isPreparation || isApproving"
    ...
    >
      ...
      <div
        v-if="(!hostSignalingMode || (isInitiator && !hostSignalingMode)) && !isJoining"
        class="flex flex-col items-center gap-6 pt-4 border-t border-white/5"
      >
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4 w-full">
          ...
          >
            <div class="absolute inset-0 bg-gradient-to-br from-primary/10 to-transparent opacity-0 group-hover:opacity-100 rounded-3xl transition-opacity duration-500" />
      ...
      <template v-else>
        ...
        <div
          v-else
          class="flex flex-col items-center gap-8 py-6"
        >
          <div
            v-if="!isPreparation"
            class="relative"
              ...
              <div class="flex items-center gap-3">
                ...
                <div class="text-left">
                  ...
                  <p class="text-[10px] text-white/30 uppercase tracking-widest font-medium">
                    Link this node to the discovery mesh
                  </p>
                </div>
              </div>
              ...
              >
                ...
                >
                  <div
                    v-if="isCopied"
                    key="check"
                    class="flex items-center gap-2 animate-bounce-short"
                  >
                    <Check class="w-4 h-4" />
                    COPIED
                  </div>
