...
<template>
  <div class="min-h-screen bg-background">
    <div class="max-w-7xl mx-auto p-6 space-y-12 shrink-0">
      ...
      <div
        v-if="game"
        class="max-w-4xl mx-auto space-y-8 animate-fade-in-up"
      >
        <button
        ...
        <div class="flex flex-col gap-8">
          ...
          <div class="flex-grow space-y-6">
            <div
              v-if="game.infoComponent"
              class="min-h-[200px]"
            >
              <template v-if="game.framework === 'vue'">
                <component
                  :is="resolvedInfoComponent"
                  v-if="resolvedInfoComponent"
                />
              </template>
              <ReactComponentWrapper
                v-else
                :component="game.infoComponent"
                :component-props="{}"
              />
            </div>
          </div>
